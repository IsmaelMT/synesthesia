...
let Examples =
{
	...
	snow :
	{
		...
		particleTexture : new THREE.TextureLoader().load( 'images/snowflake.png' ),
	...
	rain :
	{
		...
		particleTexture : new THREE.TextureLoader().load('images/raindrop2flip.png' ),
	...
	fireflies :
	{
		...
		particleTexture : new THREE.TextureLoader().load( 'images/spark.png' ),
